...
| Review and publish        | Phase 0 requires a distinct authorized reviewer.                 | Author self-review and self-publication fail regardless of role; a distinct approval is required before publication.     |
