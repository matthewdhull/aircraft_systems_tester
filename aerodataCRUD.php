...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var currentSubcategory = "performance";
...
function bindEditEvents(){
		...
		function viewAerodataQuestions(){
			...
			$("#submit_new_question_button").click(function(){
				...
				//var cat = $("#category").val("systems");
				//var subcat = $("#subcategory").val("performance");
				//var spoV = $("#spo").val("9.1.20");
		...
		$("#edit_question_button").click(function(){
			...
			//var sc = $("#edit_subcategory").val("performance");
			//var spoV = $("#edit_spo").val("9.1.20");
