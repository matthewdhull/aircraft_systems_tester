...
INSERT INTO `__new_element_versions`("id", "element_id", "subtask_version_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", "reviewed_at", "created_at", "published_at", "retired_at") SELECT "id", "element_id", "subtask_version_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", NULL, "created_at", "published_at", "retired_at" FROM `element_versions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_phase_versions`("id", "phase_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", "reviewed_at", "created_at", "published_at", "retired_at", "bloom_verb_id") SELECT "id", "phase_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", NULL, "created_at", "published_at", "retired_at", "bloom_verb_id" FROM `phase_versions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_task_versions`("id", "task_id", "phase_version_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", "reviewed_at", "created_at", "published_at", "retired_at", "bloom_verb_id") SELECT "id", "task_id", "phase_version_id", "version", "name", "description", "position", "status", "effective_from", "effective_to", "authored_by_user_id", "reviewed_by_user_id", NULL, "created_at", "published_at", "retired_at", "bloom_verb_id" FROM `task_versions`;--> statement-breakpoint
...
ALTER TABLE `legacy_curriculum_mappings` ADD `proposed_by_user_id` text NOT NULL REFERENCES users(id);--> statement-breakpoint
ALTER TABLE `legacy_curriculum_mappings` ADD `proposed_at` text NOT NULL;
